...
#
# https://www.tweag.io/posts/2019-11-28-pcf-makam-spec

# The Prolog Dictionary
# http://www.cse.unsw.edu.au/~billw/prologdict.html

# Solving a logic puzzle using Prolog
# https://stackoverflow.com/questions/1939054/solving-a-logic-puzzle-using-prolog
...
(local-set-key (kbd "<f6>") (lambda () (interactive)
  ...
  (let (kill-buffer-query-functions
    ...
    ;; Send the final query, i.e., “paste it and press enter at prompt”.
...
* COMMENT ‘=’ is Unification, or ‘incremental tell’
...
+ Cut at the end ⇒ Don't consider any more clauses of the current predicate.
   # + At the end, followed by ~fail~ ⇒ Like the above but also simply ~fail~.
...
+ [X] [[https://blog.algorexhealth.com/2018/11/a-practo-theoretical-introduction-to-logic-programming/][A Practo-Theoretical Introduction to Logic Programming]]  ---a *colourful* read showing Prolog ≈ SQL.
